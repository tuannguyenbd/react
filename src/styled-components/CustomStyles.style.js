...
export const AddressTypeStack = styled(Stack)(
  ({ theme, addressType, value }) => ({
    ...
    borderRadius: "5px",
    background: value === addressType && alpha(theme.palette.primary.mainnew, 1.0),
    cursor: "pointer",
  })
);
...
export const UserInfoGrid = styled(Grid)(({ theme, page ,userToken}) => ({
  ...
  "&::before": {
    ...
    backgroundColor: alpha(theme.palette.primary.mainnew, 1.0),
    zIndex: -1,
    [theme.breakpoints.down("md")]: {
      bottom:
...
export const UserProfileTab = styled(Button)(
  ({ theme, page, item, marginright, fontSize, borderRadius }) => ({
    background: item?.name === page && alpha(theme.palette.primary.mainnew, 1.0),
